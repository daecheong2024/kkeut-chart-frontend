...
export default function TabletCheckinPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FAF3F5] flex items-center justify-center p-6" style={{ fontFamily: "'Noto Sans KR', sans-serif" }}>
            <div className="w-full max-w-[600px] space-y-6">
                ...
                {step === 1 && (
                    <div className="rounded-2xl border border-[#F8DCE2] bg-white p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-3 gap-2 mb-4">
                                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n) => (
                                    <button
                                        ...
                                        className="h-14 rounded-xl bg-white border border-[#F8DCE2] text-xl font-bold text-[#242424] active:bg-[#FCEBEF] transition-all duration-200"
                                    >
                                        {n}
                                    </button>
                                ))}
                                <button
                                    ...
                                    className="h-14 rounded-xl bg-white border border-[#F8DCE2] text-sm font-bold text-[#242424] active:bg-[#FCEBEF] transition-all duration-200"
                                >
                                    010
                                </button>
                                <button
                                ...
                                <button
                                    ...
                                    className="h-14 rounded-xl bg-[#FCF7F8] border border-[#F8DCE2] text-sm font-bold text-[#616161] active:bg-[#FCEBEF] transition-all duration-200"
                                >
                                    지움
                                </button>
                            </div>
                        ...
                        <div className="flex gap-2">
                            <button
                                onClick={() => setPhone("")}
                                className="flex-1 h-12 rounded-xl border border-[#F8DCE2] text-sm font-bold text-[#616161] hover:bg-[#FCEBEF] transition-all duration-200"
                            >
                                전체삭제
                            </button>
                            <button
                            ...
                            <div className="mt-4 space-y-2">
                                ...
                                {patients.map((p) => (
                                    <button
                                        ...
                                        className="w-full rounded-xl border border-[#F8DCE2] bg-white px-4 py-3 text-left hover:bg-[#FCEBEF] transition-all duration-200"
                                    >
                ...
                {step === 2 && selectedPatient && (
                    <div className="rounded-2xl border border-[#F8DCE2] bg-white p-6 shadow-sm">
                        ...
                        <div className="rounded-xl bg-[#FCF7F8] border border-[#F8DCE2] p-4 mb-4 space-y-2">

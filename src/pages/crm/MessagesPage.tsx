...
function createDefaultAutomations(): AutomationRule[] {
    return [
        ...
        {
            id: "auto_default_changed",
            name: "예약 변경 시 안내 발송",
            enabled: true,
            trigger: "reservationChanged",
            schedule: { type: "immediate" },
            templateId: "tmpl_default_changed",
            filters: { branchScope: "all", excludeOptOut: true },
        },
        {
            id: "auto_default_cancelled",
            name: "예약 취소 시 안내 발송",
            enabled: true,
            trigger: "reservationCancelled",
            schedule: { type: "immediate" },
            templateId: "tmpl_default_cancelled",
            filters: { branchScope: "all", excludeOptOut: true },
        },
        {
            id: "auto_default_sameday",
            name: "당일 예약 안내",
            enabled: true,
            trigger: "sameDayReminder",
            schedule: { type: "immediate" },
            templateId: "tmpl_default_sameday",
            filters: { branchScope: "all", excludeOptOut: true },
        },
        {
            id: "auto_default_reception",
            name: "접수 시 안내 발송",
            enabled: false,
            trigger: "receptionCreated",
            schedule: { type: "immediate" },
            templateId: "tmpl_default_reception",
            filters: { branchScope: "all", excludeOptOut: true },
        },
        {
            id: "auto_default_payment",
            name: "수납 완료 시 안내 발송",
            enabled: false,
            trigger: "paymentCompleted",
            schedule: { type: "immediate" },
            templateId: "tmpl_default_payment",
            filters: { branchScope: "all", excludeOptOut: true },
        },
        {
            id: "auto_default_birthday",
            name: "생일 축하 메시지",
            enabled: false,
            trigger: "birthday",
            schedule: { type: "immediate" },
            templateId: "tmpl_default_birthday",
            filters: { branchScope: "all", excludeOptOut: true },
        },
    ];
}
...
function createDefaultTemplates(nowIso: string): MessageTemplate[] {
    return [
        ...
        {
            id: "tmpl_default_changed",
            name: "예약 변경 안내",
            channel: "sms",
            category: "예약",
            enabled: true,
            content: "안녕하세요 {{patientName}}님 :)\n{{clinicName}}입니다.\n예약이 {{date}} {{time}}으로 변경되었습니다.\n\n변동 사항이 있으시면 미리 연락 부탁드립니다.",
            variables: ["patientName", "clinicName", "date", "time"],
            updatedAt: nowIso,
        },
        {
            id: "tmpl_default_cancelled",
            name: "예약 취소 안내",
            channel: "sms",
            category: "예약",
            enabled: true,
            content: "안녕하세요 {{patientName}}님.\n{{clinicName}}입니다.\n{{date}} {{time}} 예약이 취소되었습니다.\n\n재예약을 원하시면 편하게 연락주세요. 감사합니다.",
            variables: ["patientName", "clinicName", "date", "time"],
            updatedAt: nowIso,
        },
        {
            id: "tmpl_default_sameday",
            name: "당일 예약 안내",
            channel: "sms",
            category: "예약",
            enabled: true,
            content: "안녕하세요 {{patientName}}님 :)\n{{clinicName}}입니다.\n오늘 {{time}} 예약이 있습니다.\n내원 시 편하게 방문해주세요. 감사합니다 :)",
            variables: ["patientName", "clinicName", "time"],
            updatedAt: nowIso,
        },
        {
            id: "tmpl_default_payment",
            name: "수납 완료 안내",
            channel: "sms",
            category: "수납",
            enabled: false,
            content: "안녕하세요 {{patientName}}님.\n{{clinicName}}입니다.\n수납이 완료되었습니다.\n\n궁금하신 사항이 있으시면 편하게 연락주세요. 감사합니다.",
            variables: ["patientName", "clinicName"],
            updatedAt: nowIso,
        },
        {
            id: "tmpl_default_birthday",
            name: "생일 축하",
            channel: "sms",
            category: "기타",
            enabled: false,
            content: "{{patientName}}님, 생일 진심으로 축하드립니다 :)\n{{clinicName}}입니다.\n\n오늘 하루, 누구보다 빛나는 하루 보내세요.\n늘 건강하고 아름다운 모습 응원합니다. 감사합니다 :)",
            variables: ["patientName", "clinicName"],
            updatedAt: nowIso,
        },
    ];

...
export function ReceptionForm({
    ...
    return (
        <div className="flex flex-col h-full max-h-[85vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200" style={{ fontFamily: "'Noto Sans KR', 'Noto Sans', sans-serif" }}>
            <div className="flex items-center justify-between px-5 py-3 bg-[#FCF7F8] border-b border-[#F8DCE2]">
                <div className="flex items-center gap-3">
                    <h2 className="text-[17px] font-bold text-[#5C2A35]">{isEditMode ? "접수 정보 수정" : "접수"}</h2>
                    <span className="text-[13px] text-[#616161] font-medium">
                        {format(new Date(), "yyyy-MM-dd HH:mm", { locale: ko })}
                    </span>
                </div>
                <button onClick={onClose} className="p-1.5 hover:bg-[#FCEBEF] rounded-lg transition-all duration-200">
                    <X className="w-4 h-4 text-[#616161]" />
                </button>
            </div>

            <div className="flex flex-1 overflow-hidden bg-[#FAF3F5]">
                <aside className="w-60 border-r border-[#F8DCE2] bg-white flex flex-col overflow-y-auto shrink-0">
                    <div className="px-3 pt-3 pb-2 border-b border-[#E0E0E0]">
                        <h4 className="text-[13px] font-semibold text-[#5C2A35] mb-2">주요기록</h4>
                            ...
                            <div className="space-y-1.5">
                                {recentKeyRecords.map((record: any) => (
                                    <div key={record.id} className="relative pl-4">
                                        <div className="absolute left-0 top-1.5 w-1.5 h-1.5 rounded-full bg-[#F8DCE2]" />
                                        <div className="text-[12px] text-[#242424] font-medium whitespace-pre-wrap leading-relaxed line-clamp-2">
                                            {record.content}
                                        </div>
                                        <div className="text-[10px] text-[#616161] mt-0.5">
                                        ...
                                        >
                                            <div className="flex items-center justify-between px-2 py-1.5">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    {!hasContent && !v.memo && <span className="text-[9px] text-[#E5B5C0]">기록없음</span>}
                                                </div>
                                            </div>
                                            {v.memo && (
                                            ...
                                            {isExpanded && (
                                                <div className="px-2 pb-2 space-y-1" onClick={(e) => e.stopPropagation()}>
                                                    ...
                                                    {!hasContent && <div className="text-[10px] text-[#E5B5C0] py-1">기록된 내용이 없습니다.</div>}
                                                </div>
                                            )}
                                        </div>
                                    );
                ...
                <main className="flex-1 flex overflow-hidden">
                    <div className="flex-1 overflow-y-auto p-4">
                        <div className="rounded-xl border border-[#F8DCE2] overflow-hidden mb-4 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(226,107,124,0.08)]">
                            <div className="bg-[#FCF7F8] px-4 py-2 border-b border-[#F8DCE2] flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span className="text-[12px] font-medium text-[#616161]">No. {displayChartNo}</span>
                                    <span className="text-[13px] font-bold text-[#5C2A35]">{displayName}</span>
                        ...
                        <div className="rounded-xl border border-[#F8DCE2] overflow-hidden transition-all duration-200 hover:shadow-[0_4px_12px_rgba(226,107,124,0.08)]">
                            <div className="bg-[#FCF7F8] px-4 py-2 border-b border-[#F8DCE2]">
                                <h3 className="text-[13px] font-semibold text-[#5C2A35]">접수정보</h3>
                            </div>
                            <div className="bg-white px-4 py-3 space-y-3">
                                ...
                                {currentPlanned.length > 0 && (
                                    <div className="rounded-lg border border-[#F8DCE2] bg-[#FCEBEF] p-2.5">
                                        <div className="mb-1 text-[11px] font-bold text-[#5C2A35]">예약 시술</div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full px-3 py-2 bg-[#F0F2F9] border-0 border-b-2 border-b-[#F8DCE2] rounded-t-lg text-[13px] text-[#242424] focus:outline-none focus:border-b-[#F49EAF] transition-all duration-200 appearance-none min-h-[38px]"
                                        >
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full h-20 px-3 py-2 bg-[#F0F2F9] border-0 border-b-2 border-b-[#F8DCE2] rounded-t-lg text-[13px] text-[#242424] focus:outline-none focus:border-b-[#F49EAF] transition-all duration-200 resize-none leading-relaxed"
                                    />
                                </div>
                            </div>
                        </div>
            ...
            <div className="px-5 py-2.5 border-t border-[#F8DCE2] bg-white flex items-center justify-between shrink-0">
                <div className="flex items-center gap-2">
                    <button onClick={onClose} className="px-4 py-1.5 border border-[#F8DCE2] rounded-lg text-[13px] font-bold text-[#242424] hover:bg-[#FCEBEF] transition-all duration-200 min-h-[38px]">
                        취소
                    </button>

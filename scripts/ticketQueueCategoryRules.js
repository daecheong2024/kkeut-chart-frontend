const SPECIFIC_QUEUE_CATEGORIES = [
...
const GENERAL_QUEUE_CATEGORIES = [
...
function inferQueueCategory(name) {
  ...
  return general ? general.category : "기타";
}

function normalizeTicketQueueCategory(currentQueueCategoryName, ticketName) {
  ...
  return inferQueueCategory(ticketName);
}

function getDefaultQueueDurationMinutes(queueCategoryName, usageUnit) {
  ...
  return general ? general.defaultDurationMinutes : undefined;
}

function normalizeTicketQueueDurationMinutes({
  usageUnit,
